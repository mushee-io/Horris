...
export type UnsignedUpDownCancelPlan = {
  ...
  orderType: number;
  market: string;
  reason: "frozen-order" | "pending-increase" | "manual-review";
  executionEnabled: false;
};

export function buildUnsignedUpDownCancelPlan(
  order: HorrisUpDownOrder,
  reason: UnsignedUpDownCancelPlan["reason"],
): UnsignedUpDownCancelPlan {
